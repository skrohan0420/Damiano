            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="lefttopfixed">
                        ...
                        <div class="allpagesview-bottom newleftsidecss" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <ul>
                                <li><a href="https://www.google.com/maps/place/South+City+International+School+(SCIS)/@22.5002609,88.356794,17z/data=!4m6!3m5!1s0x3a0270d89963ea53:0x878e218b8963f14b!8m2!3d22.5001841!4d88.3624578!16s%2Fg%2F11bx5613b_?authuser=0&hl=en"
                                        target="_blank"><img src="<?= base_url() ?>assetsimages/location.png" alt="location" />53, Dr. Meghnad Saha Sarani, Southern Avenue Kolkata-700 029, West Bengal, India.</a></li>
                                <li>
                        ...
                        <div class="admission_open_view" data-aos="fade-up" data-aos-duration="1000"><a href="" target="_blank"><img src="./images/newspage/5.jpg" /></a></div>
                    </div>
                </div>
                <div class="col-lg-9">
                    <div class="allpagesview-right">
                        ...
                        <div data-aos="fade-up" data-aos-duration="1000">
                            <p>
                                Damiano traces its origin as early as 1922. The company was representing the European companies for their procurement activities in India and was a part of the CTC Group which was a 
                                ...
                                It prides itself for its professionalism and focus on quality and believes that with the support of its customers it can successfully exceed its present annual capacity of 40000 tonnes.
                            </p>
                        </div>
                        <div class="row allthemegapbottom allthemegaptop">
                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                <div data-aos="fade-up" data-aos-duration="1000">
                                    <p>
                                        Damiano was established in 1968 for manufacturing Pole Line Hardware's, Steel structures, Insulator and Conductor accessories, Clamps and Connectors, ABC accessories...
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="auto-container">
            <div class="row contactus-main">
                <div class="col-lg-6 contactus-left">
                    ...
                    <div class="gettouchtext" data-aos="fade-up" data-aos-duration="2200">We’d love to hear from you!</div>
                    <ul class="gitmainclass" data-aos="fade-up" data-aos-duration="2000">
                        <li><a href="#"
                                target="_blank"><img class="addressview" src="./images/location.png" alt="#">53, Dr. Meghnad Saha Sarani, Southern Avenue
                ...
                <div class="col-lg-6 contactus-right">
                    ...
                    <div class="form" data-aos="fade-up" data-aos-duration="2400">
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <input type="text" class="form-control" placeholder="" maxlength="100" id="txtparentname">
                                <div class="icon">
